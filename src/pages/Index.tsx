...
export default function Index() {
  ...
  const [reportData, setReportData] = useState<ReportData>({
    ...
    conclusion: 'По результатам комплексного и тщательного анализа, проведённого в рамках услуги «Полная проверка на верность», мы представляем вашему вниманию подробный отчёт и выводы.\n\nМы провели глубокий цифровой анализ основного профиля ВКонтакте вашей второй половины, используя передовые поисковые системы и специализированные инструменты отслеживания. Целью было выявление активности, связанной с сервисами знакомств и флирта, а также наличие дополнительных аккаунтов. По результатам исследования, аккаунт не демонстрирует признаков участия в группах или сообществах, связанных с тематикой знакомств. Активность пользователя в переписке крайне низкая, основное время проводится за просмотром новостной ленты. Дополнительных и удалённых аккаунтов ВКонтакте, связанных с пользователем, обнаружено не было.\n\nСледует отметить, что из-за настроек приватности аккаунта ВКонтакте возможности для глубокого анализа переписки и выявления скрытых друзей были ограничены. Тем не менее, используемые нами методы позволили получить максимально полную картину с учётом данных ограничений.\n\nВ рамках расширенного поиска по социальным сетям и специализированным платформам знакомств и флирта была проведена проверка на наличие дополнительных, скрытых, удалённых или дублированных аккаунтов. Результаты исследования показали, что никакие найденные схожие профили не имеют отношения к вашей второй половине. Таким образом, с высокой степенью уверенности – 99,9% – можно утверждать, что ваша вторая половина не использует сторонние аккаунты для онлайн-знакомств или скрытых коммуникаций.\n\nТакже был проведён углублённый цифровой анализ аккаунта Telegram вашей второй половины. Используемые инструменты позволили проверить как активные, так и удалённые группы и каналы, связанные с тематикой знакомств и флирта. В ходе исследования не выявлено никаких связей, свидетельствующих о подозрительной или скрытой активности. Анализ поиска дополнительных аккаунтов Telegram также не обнаружил иных профилей, принадлежащих вашей второй половине. Аналогично ВКонтакте, из-за настроек конфиденциальности подробный анализ переписки и активности оказался ограничен.\n\nВ дополнение к проверке социальных сетей, был проведён поиск информации о покупках вашей второй половины в розничных и интернет-магазинах через открытые источники. Несмотря на выявление некоторых цифровых совпадений, при детальном анализе подтверждающих факторов не обнаружено. В целом, данных о подозрительных или необычных покупках, связанных с вашей второй половиной, не выявлено.\n\nИтог: На основании проведённой всесторонней полной проверки на верность, мы с уверенностью можем следующий итог: что ваша вторая половина не проявляет активности, связанной с онлайн-знакомствами или флиртом, не имеет скрытых или дополнительных аккаунтов в социальных сетях и специальных сервисах и не использует их для ведения двойной личной жизни. Все собранные данные не дают никаких оснований для беспокойства и подтверждают верность вашего партнёра.\n\nМы искренне рады, что результаты проверки оказались положительными. Верьте своей второй половине и дорожите вашими отношениями. Благодарим вас за ваше обращение и доверие. Желаем вам и вашей семье крепкой любви и крепких, доверительных отношений.',
    privacyPolicy: 'В целях обеспечения максимальной конфиденциальности и полной анонимности наших клиентов данный отчет передается исключительно заказчику и не сохраняется в наших системах в виде копий. После успешной отправки, отчет автоматически удаляется с сервера отправителя, что исключает его дальнейшее хранение.\n\nМы придерживаемся строгой политики конфиденциальности и гарантируем полную анонимность наших клиентов. Вся информация, связанная с заказом, не сохраняется на наших серверах после его выполнения и не передается третьим лицам при любых обстоятельствах.\n\nВся информация, которую мы предоставляем, получена исключительно из общедоступных источников и сервисов, не требующих согласия на обработку персональных данных. Это включает в себя данные, размещенные пользователями в открытом доступе в социальных сетях, на форумах, в блогах и других публичных платформах. Сбор и анализ данных цифровой активности осуществляется в рамках правового поля Российской Федерации. Мы не нарушаем права на неприкосновенность частной жизни, личную и семейную тайну, гарантированные Конституцией Российской Федерации (статья 23) и Федеральным законом № 152-ФЗ "О персональных данных". Всю информацию мы получаем исключительно из общедоступных источников и сервисов, не требующих согласия на обработку персональных данных, в соответствии с пунктом 1 части 1 статьи 6 и пунктом 10 части 1 статьи 6 указанного закона.'
  });
      ...
      <div className="bg-white border-2 border-gray-300 rounded-lg mb-8 print:border-black">
        <div className="bg-gray-100 px-6 py-4 rounded-t-lg border-b border-gray-300 flex justify-between items-center print:bg-gray-200">
          ...
          <Button 
            ...
            variant="outline"
            className="bg-blue-600 text-white hover:bg-blue-700 border-blue-600 print:hidden"
          >
            Верность.Про
          </Button>
        </div>
